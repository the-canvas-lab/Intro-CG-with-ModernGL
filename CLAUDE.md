...
| 041 | `041_Face_Culling` | Face culling shown on an open box (front wall missing, hand-wound CCW); ← → cycles: no culling (blue interior visible) / cull back (see straight through the opening — the classic see-through-walls game artifact) / cull front (inside out); `gl_FrontFacing` colours back faces blue |
