# =============================================================================
# Exercise 004 — Two Triangles
# =============================================================================
# Goal: render two triangles side by side using a single draw call.
#
# Tasks
# -----
# 1. Fill in the vertex data below (positions for 6 vertices).
#    - Left triangle  : center it on the left half of the screen.
#    - Right triangle : center it on the right half of the screen.
#
# 2. Set the correct vertex count so both triangles are drawn.
#
# Expected result: two triangles in the same color, one on each side of the window.
# =============================================================================
...
class Scene:
    def __init__(self):
        ...
        # Each row holds: x, y, z  (float32, range -1..1).
        vertices = np.array([
            # x      y      z
            # --- left triangle ---
            # ...
